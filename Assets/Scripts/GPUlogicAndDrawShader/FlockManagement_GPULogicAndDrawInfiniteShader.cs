...
public class FlockManagement_GPULogicAndDrawInfiniteShader : MonoBehaviour
{
    ...
    public float playAreaySize;

    public static FlockManagement_GPULogicAndDrawInfiniteShader Instance;
    ...
    void SetUpDrawing()
    {
        ...
        m_boidDrawingBuffer.SetData(new uint[5] {
            boidMesh.GetIndexCount(0), (uint) (boidsCount*27) , 0, 0, 0
        });

        boidMaterial.SetBuffer("boidsBuffer", m_boidLogicBuffer);
        boidMaterial.SetFloat("_BoidSize",boidSize);
        boidMaterial.SetFloat("_BoidCount",boidsCount);
        boidMaterial.SetFloat("_RepeatAreaSize",playAreaySize);
    }
    ...
    void SetUpComputeShader()
    {
        ...
        _cshader.SetFloat("_MaxAreaSize", playAreaySize);
    ...
    void CreateBoids()
    {
        ...
        {
            Vector3 pos = new Vector3(Random.Range(-playAreaySize, playAreaySize), Random.Range(-playAreaySize, playAreaySize), Random.Range(-playAreaySize, playAreaySize)) * 0.5f;
